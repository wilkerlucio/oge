...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ast,p__45512){
...
var item_b = map__45513__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45513__$1,cljs.core.cst$kw$key);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45513__$1,cljs.core.cst$kw$type);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45513__$1,cljs.core.cst$kw$params);
var temp__5457__auto__ = cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2(((function (map__45513,map__45513__$1,item_b,key,type,params){
return (function (p1__45511_SHARP_,p2__45510_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(p2__45510_SHARP_),key)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__45511_SHARP_,p2__45510_SHARP_], null);
} else {
return null;
}
});})(map__45513,map__45513__$1,item_b,key,type,params))
,cljs.core.cst$kw$children.cljs$core$IFn$_invoke$arity$1(ast)));
if(cljs.core.truth_(temp__5457__auto__)){
var vec__45515 = temp__5457__auto__;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45515,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45515,(1),null);
...
var G__45529 = com.wsscode.pathom.merge.merge_queries_STAR_(om.next.query__GT_ast(qa),om.next.query__GT_ast(qb));
if((G__45529 == null)){
return null;
} else {
return om.next.ast__GT_query(G__45529);
}
});
