...
var G__38601 = x;
var G__38602 = cljs.core.clj__GT_js(path);
return goog.object.getValueByKeys(G__38601,G__38602);
});
...
var len__12084__auto___38644 = arguments.length;
var i__12085__auto___38645 = (0);
while(true){
if((i__12085__auto___38645 < len__12084__auto___38644)){
args__12091__auto__.push((arguments[i__12085__auto___38645]));

var G__38648 = (i__12085__auto___38645 + (1));
i__12085__auto___38645 = G__38648;
continue;
} else {
}
break;
...
return cljs.core.clj__GT_js(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__38632){
var vec__38633 = p__38632;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38633,(1),null);
return cljs.core.simple_keyword_QMARK_(k);
})),cljs.core.apply.cljs$core$IFn$_invoke$arity$4(cljs.core.merge_with,com.wsscode.oge.ui.helpers.html_attr_merge,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(attrs,cljs.core.cst$kw$react_DASH_key),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__38619_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__38619_SHARP_,cljs.core.cst$kw$react_DASH_key);
}),props))));
});

com.wsscode.oge.ui.helpers.props__GT_html.cljs$lang$maxFixedArity = (1);

com.wsscode.oge.ui.helpers.props__GT_html.cljs$lang$applyTo = (function (seq38620){
var G__38621 = cljs.core.first(seq38620);
var seq38620__$1 = cljs.core.next(seq38620);
return com.wsscode.oge.ui.helpers.props__GT_html.cljs$core$IFn$_invoke$arity$variadic(G__38621,seq38620__$1);
});
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38666_SHARP_){
return ["\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38666_SHARP_),"\""].join('');
}),strings));
});
