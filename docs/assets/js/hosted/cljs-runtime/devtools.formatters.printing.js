...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28833){
var G__28834 = cljs.core.first(seq28833);
var seq28833__$1 = cljs.core.next(seq28833);
var G__28835 = cljs.core.first(seq28833__$1);
var seq28833__$2 = cljs.core.next(seq28833__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28834,G__28835,seq28833__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28868_SHARP_){
return !((cljs.core.meta(p1__28868_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28878__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28882){var _e__27499__auto__ = e28882;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e28884){var _e__27499__auto__ = e28884;
return false;
}}
})())){
...
var _STAR_current_state_STAR_28890 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__28891 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28891__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_28890;
}});
...
;
var temp__5455__auto___28895 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___28895)){
var managed_print_level_28896 = temp__5455__auto___28895;
var _STAR_print_level_STAR_28894_28897 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_28896;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_28894_28897,managed_print_level_28896,temp__5455__auto___28895,writer,opts,job_fn){
return (function (p1__28893_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28893_SHARP_,null);
});})(_STAR_print_level_STAR_28894_28897,managed_print_level_28896,temp__5455__auto___28895,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_28894_28897;
}} else {
job_fn();
}
