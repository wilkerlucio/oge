...
var o28361 = temp__5455__auto__;
var temp__5455__auto____$1 = (o28361["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o28362 = temp__5455__auto____$1;
return (o28362["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27492__auto__ = f;
return (o__27492__auto__["toString"]).call(o__27492__auto__);
} else {
return "";
}
}catch (e28365){var _ = e28365;
return "";
}});
...
try{var o__27492__auto___28380 = t;
(o__27492__auto___28380["cljs$lang$ctorPrWriter"]).call(o__27492__auto___28380,t,writer);
}catch (e28379){var __28381 = e28379;
}
...
var char_code = (function (){var o__27492__auto__ = (new String(char$));
return (o__27492__auto__["charCodeAt"]).call(o__27492__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27492__auto__ = String;
return (o__27492__auto__["fromCharCode"]).call(o__27492__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28383 = num_code;
switch (G__28383) {
case (1):
return (185);
...
var o__27492__auto__ = String;
return (o__27492__auto__["fromCharCode"]).call(o__27492__auto__,superscript_code);
});
/**
...
}catch (e28390){var _e__27499__auto__ = e28390;
return false;
}})())){
...
var vec__28391 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28391,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o28401 = temp__5455__auto__;
var temp__5455__auto____$1 = (o28401["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o28402 = temp__5455__auto____$1;
return (o28402["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___28415 = arguments.length;
var i__4500__auto___28416 = (0);
while(true){
if((i__4500__auto___28416 < len__4499__auto___28415)){
args__4502__auto__.push((arguments[i__4500__auto___28416]));

var G__28417 = (i__4500__auto___28416 + (1));
i__4500__auto___28416 = G__28417;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28411){
var vec__28412 = p__28411;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28412,(0),null);
...
var G__28418 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28419 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28418;
remaining_tokens = G__28419;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28409){
...
var vec__28424 = cljs.core.split_with((function (p1__28423_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28423_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28424,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28424,(1),null);
...
var vec__28429 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28429,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28429,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28432 = cljs.core.rest(remaining_tokens);
var G__28433 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28432;
name_tokens = G__28433;
continue;
} else {
...
var vec__28457 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28457,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__28462 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(1),null);
var vec__28465 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28465,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28465,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28469 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28469) : devtools.munging.parse_fn_info_deep.call(null,G__28469));
})()));
}
} else {
return fn_info;
...
var G__28482 = (arity + (1));
var G__28483 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28484){
var vec__28485 = p__28484;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28499_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28500_SHARP_);
...
args__4502__auto__.push((arguments[i__4500__auto___28517]));

var G__28519 = (i__4500__auto___28517 + (1));
i__4500__auto___28517 = G__28519;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28511){
var vec__28512 = p__28511;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28512,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28506){
var G__28507 = cljs.core.first(seq28506);
var seq28506__$1 = cljs.core.next(seq28506);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28507,seq28506__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28545__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28545__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28545__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28545__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28546 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28546,(4),null);
...
var o__27492__auto__ = f;
return (o__27492__auto__["getBasis"]).call(o__27492__auto__);
});
/**
...
}catch (e28551){var _e__27499__auto__ = e28551;
...
var G__28559 = (obj[cljs.core.first(path)]);
var G__28560 = cljs.core.rest(path);
obj = G__28559;
path = G__28560;
continue;
} else {
...
return (function (accum,p__28575){
var vec__28578 = p__28575;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28578,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28578,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28588){
var vec__28589 = p__28588;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28589,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28589,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28589,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28600,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28600,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__28600,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28598_SHARP_){
return (obj[cljs.core.first(p1__28598_SHARP_)]);
});})(name,sorted_matches,vec__28600,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
