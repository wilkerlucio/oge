...
var G__28552 = cljs.core.PersistentArrayMap.EMPTY;
var G__28553 = native_stack_trace;
var G__28554 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__28555 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__28552,G__28553,G__28554,G__28555) : cljs.stacktrace.parse_stacktrace.call(null,G__28552,G__28553,G__28554,G__28555));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28557__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28557__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28557__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28556){var _e = e28556;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___28561 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___28561)){
var seen_errors_28562 = temp__5455__auto___28561;
if(cljs.core.truth_(seen_errors_28562.has(self))){
} else {
seen_errors_28562.add(self);

var temp__5457__auto___28563 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___28563)){
var sense_28564 = temp__5457__auto___28563;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28564)].join('');
} else {
}
}
} else {
